...
class EnvPool(object):
    def __init__(self, agent, make_env, n_parallel_games=1):
        ...
        self.prev_memory_states = agent.memoryUnit.get_initial_state(n_parallel_games)
    ...
    def interact(self, n_steps=100, verbose=False):
        ...
        def env_step(i, action):
            if not self.just_ended[i]:
                ...
                initial_memory_state = self.agent.memoryUnit.get_initial_state(batch_size=1)
        ...
        for i in range(n_steps - 1):
            ...
            # print(new_observations[1].shape)
